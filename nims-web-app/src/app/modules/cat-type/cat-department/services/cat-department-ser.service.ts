...
export class CatDepartmentSerService extends BasicService {
  ...
  constructor(public httpClient: HttpClient, public helperService: HelperService) {
    super('nimsCommonService', 'department', httpClient, helperService);
  }
  ...
  public searchDept(first, pageSize, filters?, orders?): Observable<any> {
  ...
  public saveOrUpdateDept(item): Observable<any> {
