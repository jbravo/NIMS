 ...
 */
@Entity
@Table(name = "SUGGESTION_CALL_OFF_4G")
public class SuggestionCallOff4g implements Serializable {
  ...
  @Column(name = "CFG_SOFTWARE")
  private Integer cfgSoftware;
  @Column(name = "CFG_HARDWAVE")
  ...
  public SuggestionCallOff4g() {
  }

  public SuggestionCallOff4g(Long suggestionCallOffId) {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof SuggestionCallOff4g)) {
      return false;
    }
    SuggestionCallOff4g other = (SuggestionCallOff4g) object;
  ...
  public String toString() {
    return "Model.SuggestionCallOff4g[ suggestionCallOffId=" + suggestionCallOffId + " ]";
  }
