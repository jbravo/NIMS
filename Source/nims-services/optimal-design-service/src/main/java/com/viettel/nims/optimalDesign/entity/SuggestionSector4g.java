 ...
 */
@Entity
@Table(name = "SUGGESTION_SECTOR_4G")
public class SuggestionSector4g implements Serializable {

  private static final long serialVersionUID = 1L;
  // @Max(value=?)  @Min(value=?)//if you know range of your decimal fields consider using these annotations to enforce field validation
  @Id
  @Basic(optional = false)
  @Column(name = "SUGGESTION_SECTOR_4G_ID")
  @SequenceGenerator(name = "suggestionSector4gGenerator", sequenceName = "SUGGESTION_SECTOR_4G_SEQ")
  @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "suggestionSector4gGenerator")
  private Long suggestionSector4gId;
  ...
  public SuggestionSector4g() {
  }

  public SuggestionSector4g(Long suggestionSector4gId) {
    this.suggestionSector4gId = suggestionSector4gId;
  }

  public Long getSuggestionSector4gId() {
    return suggestionSector4gId;
  }

  public void setSuggestionSector4gId(Long suggestionSector4gId) {
    this.suggestionSector4gId = suggestionSector4gId;
  }
  ...
  public int hashCode() {
    int hash = 0;
    hash += (suggestionSector4gId != null ? suggestionSector4gId.hashCode() : 0);
    return hash;
  }
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof SuggestionSector4g)) {
      return false;
    }
    SuggestionSector4g other = (SuggestionSector4g) object;
    if ((this.suggestionSector4gId == null && other.suggestionSector4gId != null) || (this.suggestionSector4gId != null && !this.suggestionSector4gId.equals(other.suggestionSector4gId))) {
      return false;
    }
    return true;
  }
  ...
  public String toString() {
    return "Model.SuggestionSector4g[ suggestionSector4gId=" + suggestionSector4gId + " ]";
  }
