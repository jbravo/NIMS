 ...
 */
@Entity
@Table(name = "SUGGESTION_CALL_OFF_2G")
public class SuggestionCallOff2g implements Serializable {
  ...
  public SuggestionCallOff2g() {
  }

  public SuggestionCallOff2g(Long suggestionCallOffId) {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof SuggestionCallOff2g)) {
      return false;
    }
    SuggestionCallOff2g other = (SuggestionCallOff2g) object;
  ...
  public String toString() {
    return "Model.SuggestionCallOff2g[ suggestionCallOffId=" + suggestionCallOffId + " ]";
  }
