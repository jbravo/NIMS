package com.viettel.nims.commons.utils.hibernate;
  ...
  public <X> ValueBinder<X> getBinder(JavaTypeDescriptor<X> javaTypeDescriptor) {
    return new BasicBinder<X>(javaTypeDescriptor, this) {
      ...
      protected void doBind(CallableStatement callableStatement, X x, String s, WrapperOptions wrapperOptions) throws SQLException {
        final String content = getJavaDescriptor().unwrap(x, String.class, wrapperOptions);
        PGobject object = new PGobject();
        object.setType("jsonb");
        object.setValue(content);
        callableStatement.setObject(s, object);
      }
    };
  }
