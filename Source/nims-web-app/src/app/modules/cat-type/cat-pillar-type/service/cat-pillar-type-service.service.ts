...
export class CatPillarTypeServiceService extends BasicService {
  ...
  constructor(public httpClient: HttpClient, public helperService: HelperService) {
    super('nimsCommonService', 'pillarType', httpClient, helperService);
  }
  ...
  public searchPillar(first, pageSize, filters?, orders?): Observable<any> {
  ...
  public saveOrUpdatePillar(item): Observable<any> {
