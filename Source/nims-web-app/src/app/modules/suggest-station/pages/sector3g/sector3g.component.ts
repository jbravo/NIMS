...
@Component({
  selector: 'sector3g',
  templateUrl: './sector3g.component.html',
  styleUrls: ['./sector3g.component.scss']
})
export class Sector3gComponent implements OnInit {
  ...
  ngOnInit() {
    this.model = this.dataSerivce.mainData.callOff3G.sectors[this.indexSector];
