import {
  ControlContainer, FormGroupDirective, FormGroupName, FormGroup, AbstractControl, FormArrayName, FormArray
} from '@angular/forms';
...
export class HasErrorDirective implements OnInit {
  ...
  constructor(@Host() @SkipSelf() private controlContainer: ControlContainer,
